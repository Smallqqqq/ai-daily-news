# Ghostty：一个追求"全都要"的终端模拟器，以及它背后的技术抉择

![Ghostty 终端模拟器](images/cover.jpg)

> 2024 年圣诞节后一天，Mitchell Hashimoto 向世界公开了 Ghostty 1.0。在此之前，这个项目已经在封闭测试中运行了两年多，参与者从个位数缓慢增长到数千人。没有公开仓库，没有宣传文章，只有一份持续更新的 devlog 和不断扩大的内测名单。在开源软件习惯于"先公开再完善"的时代，这种做法多少有些反常。但当 1.0 最终亮相时，它在 GitHub 上迅速积累了超过 4 万颗星 -- 对于一个终端模拟器来说，这个数字意味着整个开发者社区都在关注。
