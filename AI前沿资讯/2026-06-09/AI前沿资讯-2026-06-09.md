...
---
## 1. CopilotKit — Agent 前端基础设施栈，让 React 应用原生支持 AI Agent 和生成式 UI
...
---
## 2. last30days-skill — 让 AI Agent 替你搜索 12 个社交平台的 Claude Code 技能
...
## 5. MiMo-V2.5-Pro-UltraSpeed — 全球首个 1000+ tokens/秒的万亿参数模型，运行在普通 GPU 上
